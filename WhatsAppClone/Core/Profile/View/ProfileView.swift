...
struct ProfileView: View {
    ...
    var body: some View {
        VStack {
            ...
            VStack(spacing: 32) {
                OptionView(imageName: "person.fill", title: "Name", subtitle: user?.fullname ?? "", isEditable: true, secondSubtitle: "This is not your username or pin. This name will be visible on WhatsApp contacts")
                OptionView(imageName: "exclamationmark.circle", title: "About", subtitle: "Hey tehere! I am using WhatsApp.", isEditable: true, secondSubtitle: "")
